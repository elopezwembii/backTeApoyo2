...
use App\Http\Controllers\FintocController;
...
Route::group([
    ...
    Route::post('previos', [UserController::class, 'previos']);
    ...
    Route::middleware(['auth:api', 'rutasUsuario'])->group(function () {
       ...
       Route::put('ahorro/{id}/actualizar-monto', [AhorroController::class, 'actualizarMonto']);
        ...
        //fintoc
        //Route::get('movements', [FintocController::class, 'index']);
        //Route::get('accounts', [FintocController::class, 'accounts']);
