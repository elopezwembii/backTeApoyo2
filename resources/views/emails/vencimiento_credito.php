...
<body>
    <div class="container">
        <h1>Aviso Importante: Fecha vencimiento de créditos</h1>
        <p>Hola {{ $nombre }},</p>
        <p>Te escribimos para informarte que tus créditos están pronto de llegar a la fecha de vencimiento.</p>

        <p>Te recomendamos mantener al día tus créditos.</p>
        <p class="highlight">Recuerda: ¡Mantener tus créditos controlados es clave para tu salud financiera!</p>
